...
@section('content')
            ...
            <div class="row row-cols-1 row-cols-lg-3 g-4">
                ...
                <div class="col">
                    ...
                    <div class="card payment-card">
                        ...
                        <span class="fs-1 mt-5 p-3" style="color: #e55812"><span
                                class="opacity-25 text-decoration-line-through px-2" style="color: black">5,99 EUR</span>/
                            2,99 EUR</span>
                ...
                <div class="col">
                    ...
                    <div class="card payment-card">
                        ...
                        <span class="fs-1 mt-5 p-3" style="color: #e55812"><span
                                class="opacity-25 text-decoration-line-through px-2" style="color: black">9,99
                                EUR</span>/
                            5,99 EUR</span>
                ...
                <div class="col">
                    ...
                    <div class="card payment-card">
                        ...
                        <span class="fs-1 mt-5 p-3" style="color: #e55812"><span
                                class="opacity-25 text-decoration-line-through px-2" style="color: black">12,99 EUR</span>/
                            9,99 EUR</span>

                        <div class="card-body">
                            <p class="card-text">Per un'esperienza di sponsorizzazione senza rivali, opta per il pacchetto
                                promozionale Lusso Residenziale a soli 9,99€! Assicurati visibilità premium per <span
                                    class="fw-bold" style="color: #e55812">144h</span> su piattaforme esclusive,
    ...
    <script>
        ...
        braintree.dropin.create({
            ...
            for (var i = 0; i < packageButton.length; i++) {
