<div class="apartament-form-box">
    <form action="{{ $action }}" method="POST" enctype="multipart/form-data">
        ...
        <input type="text" name="title" value="{{ old('title', $apartment?->title) }}"
            class="form-control @error('title') is-invalid @enderror" required placeholder="*">
        @error('title')
        ...
        <div class="mb-3">
            ...
            <div class="d-flex align-items-center mt-2">
                ...
                <img class="img-apartment-form" src="{{ old('thumbnail', asset('storage/' . $apartment->thumbnail)) }}"
                                    ...
                                    <div class="col">
                                        <div class="checkbox-wrapper">
                                            <input class="form-check-input" type="checkbox"
                                                ...
                                                value="{{ $service->id }}" {{ $apartment?->services->contains($service)
